...
**GitHub:** [anthropics/skills](https://github.com/anthropics/skills) — ⭐ 68621 | Forks: 6889
...
The Skill Creator is designed to assist users in developing effective skills that enhance Claude's capabilities. It provides a framework for creating modular, self-contained packages that include specialized workflows, tool integrations, and domain expertise. This skill is particularly useful when users aim to build or update skills that require procedural knowledge and detailed instructions for specific tasks. The Skill Creator emphasizes concise communication and appropriate degrees of freedom, ensuring that the skills developed are both efficient and adaptable to various contexts. By leveraging this skill, users can transform Claude into a specialized agent equipped to handle complex and repetitive tasks with ease.
...
```bash
npx -y @lobehub/market-cli skills install anthropics-skills-skill-creator
```
...
npx -y @lobehub/market-cli skills install anthropics-skills-skill-creator --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install anthropics-skills-skill-creator --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install anthropics-skills-skill-creator --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install anthropics-skills-skill-creator --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install anthropics-skills-skill-creator --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate anthropics-skills-skill-creator --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment anthropics-skills-skill-creator -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comments anthropics-skills-skill-creator
```
